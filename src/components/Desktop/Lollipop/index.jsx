...
const Lollipop = () => {
    ...
    const getDefaultImageSrc = (screenWidth) => {
        if (screenWidth >= 1101) {
            return require('../../../assets/desktop-banner/l-1.png');
        } else if (screenWidth >= 600 && screenWidth <= 950) {
            return require('../../../assets/desktop-banner/l-1.png');
        } else if (screenWidth >= 325 && screenWidth < 600) {
            return require('../../../assets/desktop-banner/l-1.png');
        } else {
            return require('../../../assets/desktop-banner/l-1.png'); // Fallback for very small screens
        }
    };
    ...
    const updateImageSrcOnScroll = () => {
        ...
        if (scrollPosition > 0) {
            if (screenWidth >= 1101) {
                setImageSrc(require('../../../assets/desktop-banner/l-1.png'));
            } else if (screenWidth >= 600 && screenWidth <= 950) {
                setImageSrc(require('../../../assets/desktop-banner/l-1.png'));
    ...
    return (
        <div className="lollipop-Desktop">
            <img
                src={imageSrc}
                alt="Welcome Banner"
                className="lollipop-image"
