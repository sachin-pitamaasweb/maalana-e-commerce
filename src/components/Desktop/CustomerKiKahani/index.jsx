...
const CustomerKiKahani = () => {
    ...
    const updateImageSrcOnScroll = () => {
        ...
        if (scrollPosition > 0) {
            if (screenWidth >= 1101) {
                setImageSrc(require('../../../assets/desktop-banner/k-1.png'));
            } else if (screenWidth >= 600 && screenWidth <= 950) {
                setImageSrc(require('../../../assets/desktop-banner/k-1.png'));
                ...
                setImageSrc(require('../../../assets/desktop-banner/mobile/k-1.png'));
            }
        } else {
    ...
    return (
        <div className="CustomerKiKahani-Desktop">
            <img
                src={imageSrc}
                alt="Welcome Banner"
                className="CustomerKiKahani-image"
            />
        </div>
    );
};

export default CustomerKiKahani;
