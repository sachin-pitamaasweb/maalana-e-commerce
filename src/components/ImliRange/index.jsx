...
//    console.log('products', products[0].images.mainImage);
...
//                                         <img src={product.images.mainImage} alt={product.name} className="product-image" />
//                                     </div>
...
import styles from './ImliRange.module.css';
...
const ImliRange = ({ products }) => {
  ...
  useEffect(() => {
    const fetchImliRange = async () => {
      if (products) {
        const filtered = products.filter(product => product.category === 'Imli Range');
